...
public class SignCommand {
	...
	private ReplyCallbackAction setSignText(SlashCommandInteractionEvent event, String mode, String rawName) {
		...
		try {
			...
			Optional<SignSettings> updated = OPEN.equals(mode)
				? signSettingsService.setOpenSign(guild.getIdLong(), name)
				: signSettingsService.setClosedSign(guild.getIdLong(), name);
